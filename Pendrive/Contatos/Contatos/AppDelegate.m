...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // carrega arquivo e joga no array
    ...
    // cria o array que guarda os contatos
    if (!self.contatos)
    {
    ...
    // cria a view com a lista de contatos
    ...
    */
    self.window.rootViewController = [lista withNavigator];
    
    // troca cor inicial da aplicacao
